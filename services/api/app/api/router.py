...
api_router.include_router(
    expense_types.router, prefix="/expense-types", tags=["费用科目管理"]
)
api_router.include_router(
    expense_records.router, prefix="/expense-records", tags=["费用记录管理"]
)
...
api_router.include_router(
    user_stores.router, prefix="/user-stores", tags=["用户门店权限"]
)
api_router.include_router(roles.router, prefix="/roles", tags=["角色管理"])
api_router.include_router(permissions.router, prefix="/permissions", tags=["权限管理"])
api_router.include_router(
    product_analysis.router, prefix="/product-analysis", tags=["菜品分析"]
)
api_router.include_router(
    comparison.router, prefix="/comparison", tags=["同比环比分析"]
)
...
api_router.include_router(finance.router, prefix="/finance", tags=["财务运营中心"])
