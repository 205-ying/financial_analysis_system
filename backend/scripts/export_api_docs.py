...
使用方法：
    python backend/scripts/export_api_docs.py                    # 导出 JSON
    python backend/scripts/export_api_docs.py --format markdown  # 导出 Markdown
    python backend/scripts/export_api_docs.py --format both      # 导出两种格式
    python backend/scripts/export_api_docs.py --output ./docs    # 指定输出目录
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
示例:
    python export_api_docs.py                        # 导出 JSON 到 backend 目录
    python export_api_docs.py --format markdown      # 导出 Markdown
    python export_api_docs.py --format both          # 导出两种格式
    python export_api_docs.py --output ./docs        # 指定输出目录
        """
    )
