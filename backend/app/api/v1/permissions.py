...
from app.schemas.permission import PermissionListItem, PermissionSchema
...
async def get_permissions(
    ...
    permissions, total = await PermissionService.get_list(
        db=db, skip=skip, limit=page_size, search=search, resource=resource
    )
...
async def get_all_permissions(
    ...
    return Response(code=200, message="查询成功", data=permissions)
...
async def get_resources(
    ...
    return Response(code=200, message="查询成功", data=resources)
...
async def get_permission(
    ...
    return Response(code=200, message="查询成功", data=permission)
